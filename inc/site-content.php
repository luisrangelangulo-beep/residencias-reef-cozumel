		...
		return array(
			'homepage_hero' => array(
				...
				'fields'      => array(
					...
					'home_proof_points'     => array( 'label' => 'Proof Bar', 'type' => 'textarea', 'help' => 'One item per line: Highlight | Supporting text' ),
				),
			),
			'homepage_sections' => array(
				...
				'fields'      => array(
					...
					'home_position_points'   => array( 'label' => 'Direct Booking Bullet Points', 'type' => 'textarea', 'help' => 'One bullet per line.' ),
					...
					'home_paths_cards'       => array( 'label' => 'Booking Path Cards', 'type' => 'textarea', 'help' => 'One card per line: Eyebrow | Title | Description | Button label' ),
					...
					'home_upgrade_cards'     => array( 'label' => 'Upgrade Cards', 'type' => 'textarea', 'help' => 'One card per line: Eyebrow | Title | Description' ),
					...
					'home_compare_condo_title' => array( 'label' => 'Condo Comparison Card Heading', 'type' => 'text' ),
					'home_compare_condo_points' => array( 'label' => 'Condo Comparison Points', 'type' => 'textarea', 'help' => 'One bullet per line.' ),
					'home_compare_villa_title' => array( 'label' => 'Villa Comparison Card Heading', 'type' => 'text' ),
					'home_compare_villa_points' => array( 'label' => 'Villa Comparison Points', 'type' => 'textarea', 'help' => 'One bullet per line.' ),
					'home_steps_title'       => array( 'label' => 'How It Works Heading', 'type' => 'text' ),
					'home_steps'             => array( 'label' => 'How It Works Steps', 'type' => 'textarea', 'help' => 'One step per line: Title | Description' ),
					...
					'home_concierge_cards'   => array( 'label' => 'Concierge Cards', 'type' => 'textarea', 'help' => 'One card per line: Title | Description' ),
					...
					'home_final_primary_label' => array( 'label' => 'Final Primary Button', 'type' => 'text' ),
					'home_final_secondary_label' => array( 'label' => 'Final WhatsApp Button', 'type' => 'text' ),
				),
			),
			'archive' => array(
