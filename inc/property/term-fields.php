...
function lvc_register_term_fields() {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array( 'key' => 'field_lvc_lterm_faq_tab', 'label' => 'FAQ', 'type' => 'tab' ),
			array( 'key' => 'field_lvc_lterm_faq_q1', 'label' => 'FAQ 1 — Question', 'name' => 'faq_q1', 'type' => 'text' ),
			array( 'key' => 'field_lvc_lterm_faq_a1', 'label' => 'FAQ 1 — Answer', 'name' => 'faq_a1', 'type' => 'textarea', 'rows' => 3 ),
			array( 'key' => 'field_lvc_lterm_faq_q2', 'label' => 'FAQ 2 — Question', 'name' => 'faq_q2', 'type' => 'text' ),
			array( 'key' => 'field_lvc_lterm_faq_a2', 'label' => 'FAQ 2 — Answer', 'name' => 'faq_a2', 'type' => 'textarea', 'rows' => 3 ),
			array( 'key' => 'field_lvc_lterm_faq_q3', 'label' => 'FAQ 3 — Question', 'name' => 'faq_q3', 'type' => 'text' ),
			array( 'key' => 'field_lvc_lterm_faq_a3', 'label' => 'FAQ 3 — Answer', 'name' => 'faq_a3', 'type' => 'textarea', 'rows' => 3 ),
			array( 'key' => 'field_lvc_lterm_faq_q4', 'label' => 'FAQ 4 — Question', 'name' => 'faq_q4', 'type' => 'text' ),
			array( 'key' => 'field_lvc_lterm_faq_a4', 'label' => 'FAQ 4 — Answer', 'name' => 'faq_a4', 'type' => 'textarea', 'rows' => 3 ),
		),
		'location' => $location,
	) );
}
