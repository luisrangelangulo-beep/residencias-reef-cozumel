...
<main class="lvc-rm">
	...
	<?php $lvc_page_body = lvc_page_body(); if ( $lvc_page_body ) : ?><section class="lvc-rm-section"><div class="lvc-rm-narrow rrc-page-content"><?php echo wp_kses_post( $lvc_page_body ); ?></div></section><?php endif; ?>
