...
<style>
	...
	.rrc-photo-grid figure{height:clamp(420px,52vw,660px);scroll-snap-stop:always}.rrc-gallery-arrow{transition:background .2s ease,border-color .2s ease,color .2s ease,opacity .2s ease}.rrc-gallery-arrow:disabled{opacity:.3;cursor:default}
