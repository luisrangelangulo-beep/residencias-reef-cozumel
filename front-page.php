...
<style>
	.rrc-home-modern{background:var(--lvc-bg);color:var(--lvc-soft);font-family:var(--lvc-font-body)}
	.rrc-home-modern *{box-sizing:border-box}.rrc-home-wrap{width:min(100%,calc(100% - clamp(2rem,6vw,6rem)));margin:0 auto}.rrc-home-narrow{width:min(980px,calc(100% - clamp(2rem,6vw,6rem)));margin:0 auto}.rrc-home-section{padding:clamp(4rem,7vw,7rem) 0}.rrc-home-section--alt{background:var(--lvc-bg-alt);border-top:1px solid var(--lvc-border);border-bottom:1px solid var(--lvc-border)}.rrc-home-kicker{display:block;margin:0 0 .85rem;color:var(--lvc-accent);font-size:.68rem;font-weight:400;letter-spacing:.2em;text-transform:uppercase}.rrc-home-title{margin:0;font-family:var(--lvc-font-display);font-size:clamp(2rem,4vw,3.65rem);font-weight:200;line-height:1.12;color:var(--lvc-text)}.rrc-home-title em{font-style:italic;color:var(--lvc-accent)}.rrc-home-copy{color:var(--lvc-soft);font-size:clamp(.98rem,1.25vw,1.08rem);font-weight:300;line-height:1.82}.rrc-home-head{text-align:center;margin:0 auto clamp(2rem,4vw,3rem);max-width:900px}.rrc-home-head .rrc-home-copy{max-width:760px;margin:1rem auto 0}.rrc-home-btns{display:flex;flex-wrap:wrap;gap:.85rem;align-items:center}.rrc-home-btn{display:inline-flex;align-items:center;justify-content:center;min-height:46px;padding:.85rem 1.45rem;border:1px solid var(--lvc-accent);background:var(--lvc-accent);color:#fff!important;font-size:.86rem;font-weight:500;border-radius:var(--lvc-radius)}.rrc-home-btn--ghost{background:transparent!important;border-color:rgba(255,255,255,.28);color:var(--lvc-text)!important}
	.rrc-home-hero{position:relative;min-height:min(720px,82vh);display:flex;align-items:center;isolation:isolate;padding:clamp(7rem,10vw,10rem) 0;background:var(--lvc-bg-deep) var(--home-hero-img,none) center/cover no-repeat}.rrc-home-hero:before{content:'';position:absolute;inset:0;z-index:-1;background:linear-gradient(90deg,rgba(10,12,15,.95),rgba(10,12,15,.72) 48%,rgba(10,12,15,.48)),linear-gradient(0deg,rgba(10,12,15,.9),rgba(10,12,15,.25) 52%,rgba(10,12,15,.64))}.rrc-home-hero__grid{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(300px,.42fr);gap:clamp(2rem,5vw,5rem);align-items:end}.rrc-home-hero h1{max-width:920px;margin:0;font-family:var(--lvc-font-display);font-size:clamp(2.55rem,5vw,5.15rem);font-weight:200;line-height:1.08;color:var(--lvc-text)}.rrc-home-hero h1 em{display:block;margin-top:.25rem;font-style:italic;color:var(--lvc-accent)}.rrc-home-hero__sub{max-width:780px;margin:1.35rem 0 0;color:rgba(243,243,241,.84);font-size:clamp(1rem,1.3vw,1.13rem);line-height:1.78}.rrc-home-hero__actions{margin-top:1.8rem}.rrc-home-match{background:linear-gradient(180deg,rgba(16,21,28,.95),rgba(10,12,15,.88));border:1px solid rgba(255,255,255,.14);padding:1.5rem;box-shadow:0 24px 70px rgba(0,0,0,.36)}.rrc-home-match h2{margin:0 0 .6rem;font-family:var(--lvc-font-display);font-weight:300;font-size:1.25rem;color:var(--lvc-text)}.rrc-home-match p{margin:0;color:var(--lvc-soft);font-size:.9rem;line-height:1.7}.rrc-home-match__facts{display:grid;grid-template-columns:1fr 1fr;gap:.65rem;margin:1.1rem 0}.rrc-home-match__fact{border:1px solid var(--lvc-border);background:rgba(255,255,255,.035);padding:.85rem}.rrc-home-match__fact strong{display:block;font-family:var(--lvc-font-display);font-size:1.45rem;font-weight:300;color:var(--lvc-text);line-height:1}.rrc-home-match__fact span{display:block;margin-top:.35rem;color:var(--lvc-muted);font-size:.66rem;letter-spacing:.12em;text-transform:uppercase}
	.rrc-proof{background:var(--lvc-bg-alt);border-top:1px solid var(--lvc-border);border-bottom:1px solid var(--lvc-border);padding:1.15rem 0}.lvc-proof__inner{display:flex;flex-wrap:wrap;justify-content:center;gap:.8rem}.lvc-proof__item{border:1px solid var(--lvc-border);padding:.6rem .85rem;color:var(--lvc-soft);font-size:.78rem;text-transform:uppercase}.lvc-proof__item strong{color:var(--lvc-accent);font-weight:500}.rrc-intro-grid{display:grid;grid-template-columns:minmax(0,.85fr) minmax(0,1.15fr);gap:clamp(2rem,5vw,5rem);align-items:center}.rrc-home-panel{border-left:1px solid var(--lvc-border);padding-left:clamp(1.5rem,3vw,3rem)}.rrc-home-panel ul{list-style:none;margin:1.35rem 0 0;padding:0;display:grid;gap:.8rem}.rrc-home-panel li{position:relative;padding-left:1.25rem;color:var(--lvc-soft);line-height:1.65}.rrc-home-panel li:before{content:'\2713';position:absolute;left:0;color:var(--lvc-accent)}
	.rrc-path-grid,.rrc-compare{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}.rrc-upgrade-grid,.rrc-steps{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}.rrc-concierge-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:.9rem}.rrc-path-card,.rrc-upgrade-card,.rrc-step,.rrc-concierge-card,.rrc-compare-card{background:var(--lvc-card);border:1px solid var(--lvc-border);padding:1.35rem}.rrc-path-card h3,.rrc-upgrade-card h3,.rrc-step h3,.rrc-concierge-card h3,.rrc-compare-card h3{margin:0 0 .6rem;font-family:var(--lvc-font-display);font-weight:300;color:var(--lvc-text)}.rrc-path-card p,.rrc-upgrade-card p,.rrc-step p,.rrc-concierge-card p{margin:0;color:var(--lvc-soft);line-height:1.65;font-size:.92rem}.rrc-upgrade-card span,.rrc-step__num{display:block;color:var(--lvc-accent);font-size:.72rem;letter-spacing:.14em;text-transform:uppercase;margin-bottom:.6rem}.rrc-compare-card ul{margin:0;padding:0;list-style:none;display:grid;gap:.7rem}.rrc-compare-card li{position:relative;padding-left:1.1rem;color:var(--lvc-soft);line-height:1.55}.rrc-compare-card li:before{content:'\2022';position:absolute;left:0;color:var(--lvc-accent)}
	.rrc-filter-pills{display:flex;flex-wrap:wrap;justify-content:center;gap:.65rem;margin:0 auto 2.2rem;max-width:1040px}.rrc-filter-pill{display:inline-flex;align-items:center;justify-content:center;border:1px solid var(--lvc-border);background:rgba(255,255,255,.025);color:var(--lvc-soft)!important;padding:.62rem .9rem;font-size:.78rem;letter-spacing:.08em;text-transform:uppercase}.rrc-filter-pill:hover{border-color:var(--lvc-accent);color:var(--lvc-accent)!important;background:var(--lvc-accent-soft)}.rrc-villa-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1.35rem}.rrc-home-pagination{display:flex;justify-content:center;align-items:center;gap:.45rem;margin-top:2.5rem;flex-wrap:wrap}.rrc-home-pagination .page-numbers{display:inline-flex;align-items:center;justify-content:center;min-width:42px;min-height:42px;padding:.55rem .8rem;border:1px solid var(--lvc-border);color:var(--lvc-soft);background:rgba(255,255,255,.02)}.rrc-home-pagination .page-numbers.current{background:var(--lvc-accent);border-color:var(--lvc-accent);color:#fff}
	.rrc-area-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem}.rrc-tulum-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:1rem}.rrc-tulum-grid>.rrc-area-tile{grid-column:span 2}.rrc-tulum-grid>.rrc-area-tile:nth-last-child(2){grid-column:1/span 3}.rrc-tulum-grid>.rrc-area-tile:last-child{grid-column:4/span 3}.rrc-area-tile{position:relative;min-height:330px;display:flex;align-items:flex-end;padding:1.35rem;border:1px solid var(--lvc-border);background:var(--lvc-card) var(--area-img,none) center/cover no-repeat;overflow:hidden}.rrc-tulum-grid .rrc-area-tile{min-height:285px}.rrc-area-tile:before{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(10,12,15,.12),rgba(10,12,15,.92))}.rrc-area-tile__body{position:relative;z-index:1}.rrc-area-tile h3{margin:0;font-family:var(--lvc-font-display);font-size:1.35rem;font-weight:300;color:var(--lvc-text)}.rrc-area-tile p{margin:.55rem 0 0;color:var(--lvc-soft);font-size:.86rem;line-height:1.55}.rrc-area-tile span{display:block;margin-top:.85rem;color:var(--lvc-accent);font-size:.82rem}.rrc-final-cta{background:var(--lvc-bg-deep);border-top:1px solid rgba(255,255,255,.12);text-align:center}.rrc-final-cta .rrc-home-copy{max-width:680px;margin:1rem auto 1.6rem}.rrc-final-cta .rrc-home-btns{justify-content:center}
	.rrc-home-compare{text-align:center;max-width:760px;margin:2.2rem auto 0;color:var(--lvc-soft);font-size:.95rem;line-height:1.7}.rrc-home-compare a{color:var(--lvc-accent);text-decoration:underline;text-underline-offset:3px}.rrc-home-compare a:hover{color:var(--lvc-accent-hover)}
	@media(max-width:1100px){.rrc-home-hero__grid,.rrc-intro-grid,.rrc-path-grid,.rrc-compare{grid-template-columns:1fr}.rrc-area-grid,.rrc-villa-grid,.rrc-tulum-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.rrc-tulum-grid>.rrc-area-tile,.rrc-tulum-grid>.rrc-area-tile:nth-last-child(2),.rrc-tulum-grid>.rrc-area-tile:last-child{grid-column:auto}.rrc-tulum-grid>.rrc-area-tile:last-child{grid-column:1/-1}.rrc-upgrade-grid,.rrc-concierge-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.rrc-home-panel{border-left:0;padding-left:0}}@media(max-width:720px){.rrc-home-wrap,.rrc-home-narrow{width:calc(100% - 2rem)}.rrc-home-hero{min-height:auto;padding:6rem 0 4rem}.rrc-home-hero h1{font-size:clamp(2.3rem,12vw,3.5rem)}.rrc-home-btns{display:grid;grid-template-columns:1fr}.rrc-home-match__facts,.rrc-area-grid,.rrc-steps,.rrc-concierge-grid,.rrc-villa-grid,.rrc-path-grid,.rrc-upgrade-grid,.rrc-tulum-grid,.rrc-compare{grid-template-columns:1fr}.rrc-tulum-grid>.rrc-area-tile:last-child{grid-column:auto}.lvc-proof__item{width:100%;text-align:center}.rrc-filter-pills{justify-content:flex-start}}
</style>

<main class="rrc-home-modern">
	<section class="rrc-home-hero" <?php echo $lvc_home_hero_img ? 'style="--home-hero-img:url(\'' . esc_url( $lvc_home_hero_img ) . '\')"' : ''; ?> aria-label="Residencias Reef Cozumel and private Riviera Maya villa rentals"><div class="rrc-home-wrap rrc-home-hero__grid"><div><span class="rrc-home-kicker"><?php echo esc_html( $lvc_home_hero_kicker ); ?></span><h1><?php echo esc_html( $lvc_home_hero_title ); ?> <em><?php echo esc_html( $lvc_home_hero_accent ); ?></em></h1><p class="rrc-home-hero__sub"><?php echo esc_html( $lvc_home_hero_intro ); ?></p><div class="rrc-home-btns rrc-home-hero__actions"><a class="rrc-home-btn" href="<?php echo esc_url( $lvc_req ); ?>"><?php echo esc_html( $lvc_home_primary_label ); ?></a><a class="rrc-home-btn rrc-home-btn--ghost" href="<?php echo esc_url( $lvc_arch ); ?>"><?php echo esc_html( $lvc_home_secondary_label ); ?></a></div></div><aside class="rrc-home-match"><h2><?php echo esc_html( $lvc_home_match_title ); ?></h2><p><?php echo esc_html( $lvc_home_match_intro ); ?></p><div class="rrc-home-match__facts"><div class="rrc-home-match__fact"><strong>Direct</strong><span>No OTA markup</span></div><div class="rrc-home-match__fact"><strong>Local</strong><span>Villa guidance</span></div></div><a class="rrc-home-btn" href="<?php echo esc_url( $lvc_req ); ?>"><?php echo esc_html( $lvc_home_match_label ); ?></a></aside></div></section>
	<?php if ( function_exists( 'lvc_render_filter_bar' ) ) { lvc_render_filter_bar(); } ?>

	<section class="rrc-proof"><div class="rrc-home-wrap lvc-proof__inner"><?php foreach ( $lvc_home_proof_points as $point ) : ?><div class="lvc-proof__item"><strong><?php echo esc_html( $point[0] ); ?></strong> <?php echo esc_html( $point[1] ); ?></div><?php endforeach; ?></div></section>

	<section class="rrc-home-section" id="feat"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Featured Stays</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_featured_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_featured_intro ); ?></p></header><nav class="rrc-filter-pills" aria-label="Villa collection filters"><?php foreach ( $lvc_collection_filters as $filter ) : ?><a class="rrc-filter-pill" href="<?php echo esc_url( $filter[1] ); ?>"><?php echo esc_html( $filter[0] ); ?></a><?php endforeach; ?></nav><?php $lvc_cozumel = new WP_Query( array( 'post_type' => $lvc_cpt, 'posts_per_page' => 3, 'post_status' => 'publish', 'fields' => 'ids', 'no_found_rows' => true, 'orderby' => 'date', 'order' => 'DESC', 'tax_query' => array( array( 'taxonomy' => 'area', 'field' => 'slug', 'terms' => 'cozumel', 'include_children' => true ) ) ) ); $lvc_featured_ids = array_map( 'intval', $lvc_cozumel->posts ); $lvc_more = new WP_Query( array( 'post_type' => $lvc_cpt, 'posts_per_page' => 6, 'post_status' => 'publish', 'fields' => 'ids', 'no_found_rows' => true, 'post__not_in' => $lvc_featured_ids, 'orderby' => 'date', 'order' => 'DESC' ) ); $lvc_featured_ids = array_merge( $lvc_featured_ids, array_map( 'intval', $lvc_more->posts ) ); $lvc_villas = new WP_Query( array( 'post_type' => $lvc_cpt, 'posts_per_page' => 9, 'post_status' => 'publish', 'post__in' => $lvc_featured_ids, 'orderby' => 'post__in', 'no_found_rows' => true ) ); if ( $lvc_villas->have_posts() ) : ?><div class="rrc-villa-grid"><?php while ( $lvc_villas->have_posts() ) : $lvc_villas->the_post(); get_template_part( 'template-parts/card-property', null, array( 'id' => get_the_ID() ) ); endwhile; ?></div><div class="rrc-home-btns" style="justify-content:center;margin-top:2rem"><a class="rrc-home-btn rrc-home-btn--ghost" href="<?php echo esc_url( $lvc_arch ); ?>">View All Villas &amp; Condos</a></div><?php wp_reset_postdata(); endif; ?></div></section>

	<section class="rrc-home-section rrc-home-section--alt"><div class="rrc-home-wrap rrc-intro-grid"><div><span class="rrc-home-kicker">Direct Booking Collection</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_position_title ); ?></h2></div><div class="rrc-home-panel rrc-home-copy"><p><?php echo esc_html( $lvc_home_position_intro ); ?></p><ul><?php foreach ( $lvc_home_position_points as $point ) : ?><li><?php echo esc_html( $point[0] ); ?></li><?php endforeach; ?></ul></div></div></section>

	<section class="rrc-home-section"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Two Booking Paths</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_paths_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_paths_intro ); ?></p></header><div class="rrc-path-grid"><?php foreach ( $lvc_home_paths_cards as $index => $card ) : ?><article class="rrc-path-card"><span class="rrc-home-kicker"><?php echo esc_html( $card[0] ); ?></span><h3><?php echo esc_html( $card[1] ); ?></h3><p><?php echo esc_html( $card[2] ); ?></p><a class="rrc-home-btn<?php echo 0 === $index ? ' rrc-home-btn--ghost' : ''; ?>" href="<?php echo esc_url( 0 === $index ? home_url( '/cozumel/' ) : $lvc_req ); ?>"><?php echo esc_html( $card[3] ); ?></a></article><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section rrc-home-section--alt"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">When to Upgrade</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_upgrade_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_upgrade_intro ); ?></p></header><div class="rrc-upgrade-grid"><?php foreach ( $lvc_home_upgrade_cards as $card ) : ?><article class="rrc-upgrade-card"><span><?php echo esc_html( $card[0] ); ?></span><h3><?php echo esc_html( $card[1] ); ?></h3><p><?php echo esc_html( $card[2] ); ?></p></article><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section rrc-home-section--alt"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Where to Stay</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_area_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_area_intro ); ?></p></header><div class="rrc-area-grid"><?php foreach ( $lvc_area_cards as $area ) : $area_img = lvc_area_image( $area[1] ); $area_desc = lvc_home_term_description( 'area', $area[1], $area[3] ); ?><a class="rrc-area-tile" href="<?php echo esc_url( home_url( $area[2] ) ); ?>" style="<?php echo $area_img ? '--area-img:url(\'' . esc_url( $area_img ) . '\')' : ''; ?>"><div class="rrc-area-tile__body"><h3><?php echo esc_html( $area[0] ); ?></h3><p><?php echo esc_html( $area_desc ); ?></p><span>Explore <?php echo esc_html( $area[0] ); ?> &rarr;</span></div></a><?php endforeach; ?></div><p class="rrc-home-compare">Not sure which to choose? Compare <a href="<?php echo esc_url( home_url( '/cozumel-vs-tulum-vs-playa-del-carmen-villa-rentals/' ) ); ?>">Cozumel vs Tulum vs Playa del Carmen</a> or <a href="<?php echo esc_url( home_url( '/tulum-vs-playa-del-carmen-comparison-guide/' ) ); ?>">Tulum vs Playa del Carmen</a>.</p></div></section>

	<section class="rrc-home-section"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Browse by Collection</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_collection_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_collection_intro ); ?></p></header><div class="rrc-area-grid"><?php foreach ( $lvc_collections as $collection ) : $collection_img = lvc_home_term_image( 'collection', $collection[1] ); if ( ! $collection_img && ! empty( $collection[4] ) ) { $collection_img = $collection[4]; } $collection_desc = lvc_home_term_description( 'collection', $collection[1], $collection[3] ); ?><a class="rrc-area-tile" href="<?php echo esc_url( $collection[2] ); ?>" style="<?php echo $collection_img ? '--area-img:url(\'' . esc_url( $collection_img ) . '\')' : ''; ?>"><div class="rrc-area-tile__body"><h3><?php echo esc_html( $collection[0] ); ?></h3><p><?php echo esc_html( $collection_desc ); ?></p><span>Explore collection &rarr;</span></div></a><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section rrc-home-section--alt"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Tulum Villa Areas</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_tulum_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_tulum_intro ); ?></p></header><div class="rrc-tulum-grid"><?php foreach ( $lvc_tulum_areas as $area ) : $area_img = lvc_area_image( $area[1] ); $area_desc = lvc_home_term_description( 'area', $area[1], $area[3] ); ?><a class="rrc-area-tile" href="<?php echo esc_url( home_url( $area[2] ) ); ?>" style="<?php echo $area_img ? '--area-img:url(\'' . esc_url( $area_img ) . '\')' : ''; ?>"><div class="rrc-area-tile__body"><h3><?php echo esc_html( $area[0] ); ?></h3><p><?php echo esc_html( $area_desc ); ?></p><span>Explore <?php echo esc_html( $area[0] ); ?> villas &rarr;</span></div></a><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Cozumel or Villa Upgrade</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_compare_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_compare_intro ); ?></p></header><div class="rrc-compare"><article class="rrc-compare-card"><h3><?php echo esc_html( $lvc_home_compare_condo_title ); ?></h3><ul><?php foreach ( $lvc_home_compare_condo_points as $point ) : ?><li><?php echo esc_html( $point[0] ); ?></li><?php endforeach; ?></ul></article><article class="rrc-compare-card"><h3><?php echo esc_html( $lvc_home_compare_villa_title ); ?></h3><ul><?php foreach ( $lvc_home_compare_villa_points as $point ) : ?><li><?php echo esc_html( $point[0] ); ?></li><?php endforeach; ?></ul></article></div></div></section>

	<section class="rrc-home-section rrc-home-section--alt"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">How It Works</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_steps_title ); ?></h2></header><div class="rrc-steps"><?php foreach ( $lvc_home_steps as $index => $step ) : ?><div class="rrc-step"><span class="rrc-step__num"><?php echo esc_html( str_pad( (string) ( $index + 1 ), 2, '0', STR_PAD_LEFT ) ); ?></span><h3><?php echo esc_html( $step[0] ); ?></h3><p><?php echo esc_html( $step[1] ); ?></p></div><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section"><div class="rrc-home-wrap"><header class="rrc-home-head"><span class="rrc-home-kicker">Concierge Services</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_concierge_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_concierge_intro ); ?></p></header><div class="rrc-concierge-grid"><?php foreach ( $lvc_home_concierge_cards as $card ) : ?><div class="rrc-concierge-card"><h3><?php echo esc_html( $card[0] ); ?></h3><p><?php echo esc_html( $card[1] ); ?></p></div><?php endforeach; ?></div></div></section>

	<section class="rrc-home-section rrc-final-cta"><div class="rrc-home-narrow"><span class="rrc-home-kicker">Start Planning</span><h2 class="rrc-home-title"><?php echo esc_html( $lvc_home_final_title ); ?></h2><p class="rrc-home-copy"><?php echo esc_html( $lvc_home_final_intro ); ?></p><div class="rrc-home-btns"><a class="rrc-home-btn" href="<?php echo esc_url( $lvc_req ); ?>"><?php echo esc_html( $lvc_home_final_primary_label ); ?></a><?php if ( $lvc_wa ) : ?><a class="rrc-home-btn rrc-home-btn--ghost" href="<?php echo esc_url( $lvc_wa ); ?>" target="_blank" rel="noopener"><?php echo esc_html( $lvc_home_final_secondary_label ); ?></a><?php endif; ?></div></div></section>
</main>
<?php get_footer(); ?>
