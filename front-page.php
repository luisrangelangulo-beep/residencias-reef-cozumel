...
$lvc_area_cards = array(
	array( 'Cozumel', 'cozumel', '/cozumel-luxury-villas/', 'Island beachfront villas and Residencias Reef condos, close to world-class diving, ferry access, and a quieter island pace.' ),
	array( 'Tulum', 'tulum', '/tulum-luxury-villas/', 'Bohemian-luxury villas and jungle-beach estates across Tulum, Sian Ka\'an, and the Tulum Beach Zone.' ),
	array( 'Playa Del Carmen', 'playa-del-carmen', '/playa-del-carmen-luxury-villas/', 'Beachfront and Playacar villas minutes from 5th Avenue, dining, and nightlife.' ),
	array( 'Akumal', 'akumal', '/akumal-luxury-villas/', 'Laid-back bayfront villas near sea-turtle snorkeling and quieter Caribbean beaches.' ),
);

$lvc_collection_filters = array_merge(
	array( array( 'All Villas', $lvc_arch ) ),
	array(
		array( 'Cozumel', home_url( '/cozumel-luxury-villas/' ) ),
		array( 'Tulum', home_url( '/tulum-luxury-villas/' ) ),
		array( 'Playa Del Carmen', home_url( '/playa-del-carmen-luxury-villas/' ) ),
		array( 'Akumal', home_url( '/akumal-luxury-villas/' ) ),
		array( 'Puerto Aventuras', home_url( '/puerto-aventuras-luxury-villas/' ) ),
	)
);
?>
